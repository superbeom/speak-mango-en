...
const DialogueItem = memo(
  forwardRef<DialogueAudioButtonHandle, DialogueItemProps>(
    (
      {
        item,
        index,
      ...
      const handleEnglishClick = () => {
        ...
        if (isEnglishBlurred) {
          onEnglishClick(index);
        }
      };

      const handlePlay = () => onPlay(index);
      const handleEnded = () => onEnded(index);
      const handleReady = () => onReady(index);
