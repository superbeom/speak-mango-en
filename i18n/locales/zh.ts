...
export const zh = {
  ...
  error: {
    ...
    codes: {
      ...
      VOCABULARY_COPY_FAILED: "复制项目失败。",
      VOCABULARY_MOVE_FAILED: "移动项目失败。",
    },
  },
  auth: {
    signIn: "登录",
  ...
  vocabulary: {
    ...
    selectAll: "全选",
    deselectAll: "取消全选",
    copySuccess: "选中的项目已复制。",
    moveSuccess: "选中的项目已移动。",
    itemsDeleteConfirm: "确定要删除选中的项目吗？",
    itemsDeleteSuccess: "选中的项目已删除。",
