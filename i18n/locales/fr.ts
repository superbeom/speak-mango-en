...
export const fr = {
    meta: {
        ...
        expressionDesc: "Signification de {expression} : {meaning}. Apprenez avec une prononciation native sur {serviceName}.",
    ...
    home: {
        ...
        description: "Apprenez des expressions anglaises utiles facilement et en vous amusant.",
