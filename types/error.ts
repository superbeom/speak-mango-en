...
export type VocabularyErrorCode =
  ...
  | "VOCABULARY_COPY_FAILED"
  | "VOCABULARY_MOVE_FAILED";
...
export const ACTION_ERROR = {
  ...
  PREMIUM_REQUIRED: COMMON_ERROR.PREMIUM_REQUIRED,
...
export const VOCABULARY_ERROR = {
  ...
  DELETE_FAILED: "VOCABULARY_DELETE_FAILED",
  NOT_FOUND: "VOCABULARY_NOT_FOUND",
  COPY_FAILED: "VOCABULARY_COPY_FAILED",
  MOVE_FAILED: "VOCABULARY_MOVE_FAILED",
} as const;
